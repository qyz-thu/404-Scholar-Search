<template xmlns="http://www.w3.org/1999/html">
  <div v-if='isPaper' style="padding: 10px; border: 1px; height: 100px; background-color: #edf0f5">
  ...
  <div v-else style="padding: 10px; border: 1px; height: 130px; background-color: #edf0f5">
